...
<div class="row">
  ...
  <div class="col-lg-6">
    ...
    <p>
      <a class="btn btn-secondary" href="mailto:nem2p@virginia.edu" role="button"><i class="fa fa-envelope fa-md"></i></a>
      <a class="btn btn-secondary" href="https://stackoverflow.com/users/473488/neal" role="button"><i class="fa fa-stack-overflow fa-md"></i></a>
      <a class="btn btn-secondary" href="https://github.com/nmagee/" role="button"><i class="fa fa-github fa-md"></i></a>
    </p>
  </div><!-- /.col-lg-6 -->
  <div class="col-lg-6">
