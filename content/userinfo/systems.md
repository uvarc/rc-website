...
<div class = "card-group">
  <div class="card">
    <div class="card-block">
      <h4 class="card-title">Container Services <span style="background-color:yellow;font-size:60%; padding:3px; border: solid 2px #ccc;">BETA</span></h4>
        <p class="card-text">
        Do you have a container-based service or web application to run for your research project? We are now running DC/OS, a platform designed for running fleets of containers independently of one another. This includes web applications, databases, specialized tools, and other solutions in support of HPC jobs.
        </p>
