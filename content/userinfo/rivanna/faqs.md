...
Some users logging in through ssh may encounter this error message. If you receive this message, please visit https://arcs.virginia.edu/ssh#toc-3 and look at item #5 for instructions on how to clear your known-hosts file. If you are running MobaXterm on Windows, you will be prompted to update your host key and should respond with "yes."
...
We use the Lmod system for managing software environments.  More information is here.
...
## How do I share data in my `/scratch` or leased storage with a colleage?
...
To check your leased space, change directory into your your leased space and then run df -h /nv/volX/yourshare, where volX is your leased storage volume and your share name is the name of the group set up for the storage:
