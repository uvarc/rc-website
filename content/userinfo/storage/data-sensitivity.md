...
<table class="table table-sm table-striped" style="font-size:90%; margin-top: 1rem;">
  <thead class="thead-dark">
    ...
    <tr>
      ...
      <th style="width:12%;">Rivanna/Afton (/home &amp; /scratch)</th>
      <th style="width:12%;">High-Security Research Standard </th>
      <th style="width:12%;">High-Security Research Project </th>
      <th style="width:12%;">Ivy VM (/home)</th>
      <th style="width:12%;">Rio HPC </th>
<!--      <th style="width:12%;">ACCORD</th>  -->
    </tr>
  </thead>
  <tbody>
...
<!--      <td>❌</td> -->
    ...
    <tr>
      <td>Health Information without PHI (including de-identified datasets)<sup> <a href="#footnote2"> 2 </a> </sup></td>
      <td>✅</td>
      <td>✅</td>
      <td>✅</td>
      <td>✅</td>
...
<!--      <td>✅</td> -->
    ...
    <tr>
      <td>Health Information with PHI (including limited datasets)<sup> <a href="#footnote3"> 1 </a> </sup></td>
      <td>❌</td>
      <td>❌</td>
      <td>❌</td>
      <td>✅</td>
