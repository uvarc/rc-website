...
Prior to requesting a new standard allocation, please make sure to request a new Grouper group to manage access to the allocation, and explicitly add yourself as a member of the new group via <a href="https://groups.identity.virginia.edu/">Grouper</a>.
...
Prior to requesting a new paid allocation, please make sure to request a new Grouper group to manage access to the allocation, and explicitly add yourself as a member of the new group via <a href="https://groups.identity.virginia.edu/">Grouper</a>.
...
Prior to requesting a new instructional allocation, please make sure to request a new Grouper group to manage access to the allocation, and explicitly add yourself as a member of the new group via <a href="https://groups.identity.virginia.edu/">Grouper</a>.
