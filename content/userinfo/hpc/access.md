...
Access to all RC services in the standard security zone are controlled by membership to Grouper groups. For those unfamiliar with using Grouper, ITS has some helpful video tutorials: <a href="https://www.youtube.com/watch?v=Hq_GJfIeoBI">Grouper Portal Overview</a>, <a href="https://www.youtube.com/watch?v=j0_Shp2xYxw">Creating and Deleting Groups in Grouper</a>, Creating and Deleting Groups in Grouper, and <a href="https://www.youtube.com/watch?v=j0_Shp2xYxw">Add - Remove Group Members in Grouper</a>.
