...
- **Since February 26:** A total of 988.1 TB out of 4.3 PB have been copied from old Project storage to the /stagedproject folder on the new storage system since February 26 (23.0%). This dataset will eventually comprise a complete duplicate of all files on the old Project storage system.
{{% /callout %}}
...
## How should I prepare for the changes coming on February 26?
...
## Some of my Project storage files disappeared. Where did they go?
...
## Where are you copying my files?
...
## How do I access the new /stagedproject folder?
...
## How can I work with the files that have been transferred into my /stagedproject folder?
...
## Why can't I access the old Project storage system directly to copy my own files?
...
## How do I find out what files are on the old Project storage system?
...
## Are all files being transferred to the new Project storage system at once?
...
## Can I pick which of my files are transferred first?
...
## How can I get an estimate of when my files will be transferred?
...
## Why is the transfer of folders to the new Project storage system taking longer than expected?
...
## What caused this issue with the old Project storage file system?
...
## What is RC doing to ensure increased reliability and improved service?
...
## How were files prioritized for transfer for the new system?
...
## What are stub files and how can I find them?
...
## Why do I get File Not Found Errors when accessing some of my files in my /project subfolders?
...
## How can I verify that all my old project storage files are now in /stagedproject?
...
## How can I consolidate my files in /stagedproject and /project?
...
## How can I get help with the data migration process?
