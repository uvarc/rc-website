...
date = "2024-04-16T00:00:00-00:01"
tags = [
  "service",
  "status",
  "storage",
...
- **Since February 26:** A total of 2.8 PB out of 4.3 PB have been copied from old Project storage to the /stagedproject folder on the new storage system since February 26 (65.1%). This dataset will eventually comprise a complete duplicate of all files on the old Project storage system.
{{% /callout %}}
