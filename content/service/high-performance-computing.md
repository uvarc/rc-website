...
<div class="card" style="margin:2rem;">
  <div class="card-block">
    ...
    <p class="card-text">
Rio is one of the recent University of Virginia’s High-Performance Computing (HPC) systems, specifically designed for the processing and analysis of controlled-access and highly sensitive data. Rio consists of over 39 HPC nodes, each equipped with 375 GB of RAM and offering a combined total of more than 1,600 x86 64-bit compute cores. Researchers can use Rio to process and store sensitive data with the confidence that the environment is secure and meets HIPAA, FERPA, ITAR requirements.     
</p>
