...
<div>
  ...
  <div class="row">
    ...
    <div class="col form-item form-type-textarea form-group">
      ...
      <p class=tiny>This will be the name of your storage space on the file system and may not contain spaces. The name does not necesarily need to be the same as the associated the Grouper group. <strong>If you are modifying an existing storage share, please ensure this name matches exactly how it is visible on the file system.</strong></p>
    </div>
    {{% group_creation_tip %}}          
  </div>
  <hr size=1 />
