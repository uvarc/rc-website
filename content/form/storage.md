...
<div>
  ...
  <div class="row">
    ...
    <div class="col form-item form-type-textarea form-group">
      ...
      <p class=tiny>This will be the name of your storage space on the file system. The name may not contain spaces and it can, but does not necesarily need to be the same as the associated Grouper group. <strong>**If you are modifying an existing storage space, please ensure the name matches exactly how it is listed on the file system.</strong></p>
    </div>
    {{% group_creation_tip %}}          
  </div>
  <hr size=1 />
