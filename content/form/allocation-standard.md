    ...
    <div class="row">
      <div id="yes-or-no" class="form-radios col">
        <div class="form-item form-type-radio radio"> <label class="control-label" for="yes-or-no-1">
          <input required="required" type="radio" id="yes-or-no-1" name="yes-or-no" value="yes" checked="checked" class="form-radio" />&nbsp;Yes</label>
        </div>
        <div class="form-item form-type-radio radio"> <label class="control-label" for="yes-or-no-2">
          <input required="required" type="radio" id="yes-or-no-2" name="yes-or-no" value="no" class="form-radio" />&nbsp;No</label>
        </div>
      </div>
    </div>
  </div>
