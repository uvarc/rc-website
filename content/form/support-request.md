...
{{% form-userinfo-v2 %}}
  <div class="form-item form-group form-item form-type-select form-group" style="margin-bottom:1.6rem;">
    ...
    <div id="dataanalytics-help" style="font-size:90%;" class="form-text text-muted">Use this form for queries related to services offered by our Data Analytics Center. Learn more about the <a href="/service/dac/" style="font-weight:bold;">Data Analytics Center</a>.</div>
  </div>
