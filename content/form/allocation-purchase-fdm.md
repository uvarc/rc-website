...
<div>
  ...
  {{% form-userinfo %}}
  <hr size=1 />
  <alert style="width:100%;padding:0.6rem;margin-bottom:1.4rem;" class="alert alert-success" role="alert">For current allocation pricing please <a 
href="/userinfo/rivanna/allocations/#allocation-pricing" 
